...
export const Hero = () => {
  return (
    <section className="w-full h-screen bg-[url('/public/Img/hero-bg-img.png')] bg-no-repeat bg-cover bg-right text-white">
      <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-8 lg:gap-[18px] py-36 px-6 md:px-20 container max-w-[1400px] mx-auto">
        <div>
