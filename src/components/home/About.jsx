...
const About = () => {
    return (
        ...
        <div className="w-full sm:h-screen bg-[url('/Img/about-bg-img.png')] bg-no-repeat bg-cover bg-right-bottom text-white flex items-center justify-start max-w-[1344px] max-h-[564x] mx-auto rounded-3xl py-8 px-6 md:px-20 container my-6">
          <div>
            <h2 className="text-[#FFFFFF] font-heading text-[28px] leading-[34.13px] md:text-[32px] md:leading-[39.01px] font-semibold tracking-tighter mb-2 md:mb-[9px] text-pretty max-w-[591px]">
            Allocate effort where your reps make an impact.
            </h2>
            <h2 className="text-primary italic font-heading text-[24px] leading-[29.26px] md:text-[32px] md:leading-[39.01px] font-medium tracking-tighter">
            Let us handle the rest.
            </h2>
            <p className="text-[#FFFFFF] font-body text-lg leading-[23.4px] md:text-[20px] md:leading-[26px] font-light tracking-tighter max-w-[582px] mt-6 md:mt-[17px] mb-[30px] md:mb-[94px]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-6 gap-y-8">
                {aboutList.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className='text-[#E9EEF1] font-heading text-lg leading-[23.4px] md:text-xl md:leading-[26px] font-light tracking-tighter'>{feature.description}</p>
                  </div>
                ))}
            </div>
          </div>
